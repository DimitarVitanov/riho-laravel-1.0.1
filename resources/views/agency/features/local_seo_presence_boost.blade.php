...
<div class="container-fluid local-seo-feature">
    ...
    <div id="listingPreviewModal" style="display:none;position:fixed;top:0;bottom:0;left:var(--sidebar-width, 250px);right:0;background:rgba(0,0,0,0.5);z-index:999;align-items:center;justify-content:center;">
        <div style="background:#fff;border-radius:16px;width:calc(100% - 48px);max-height:90vh;overflow:auto;position:relative;margin:24px;">
