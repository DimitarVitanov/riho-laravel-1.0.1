...
.original-hero{background:#0A0B0D url('https://app.villabit.ai/lines.webp') center/cover no-repeat;}
...
<img alt="Villa visualization" class="wide-image" onclick="openViewer(this.src)" src="https://app.villabit.ai/mainVilla.png"/>
...
<div class="modal-viewer" id="videoViewer"><span class="modal-close" onclick="closeVideoViewer()">×</span><video id="droneVideo" controls autoplay loop style="max-width:95vw;max-height:90vh;border-radius:12px;"><source src="https://app.villabit.ai/MilnaDroneAerial.mp4" type="video/mp4"></video></div>
<script>
