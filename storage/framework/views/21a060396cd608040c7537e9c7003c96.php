...
?>
      <div class="page-header">
          <div class="header-wrapper row m-0">
                      ...
                      <div class="Typeahead Typeahead--twitterUsers">
                          <div class="u-posRelative">
                              <input class="demo-input Typeahead-input form-control-plaintext w-100" type="text"
                                  placeholder="Search <?php echo e($settings['general']['site_name']); ?> .." name="q" title="" autofocus>
              ...
              <div class="header-logo-wrapper col-auto p-0">
                  <div class="logo-wrapper"> <a href="<?php echo e(route('admin.default_dashboard')); ?>"><img
                              class="img-fluid for-light" src="<?php echo e(asset('assets/images/logo/logo_dark.png')); ?>"
                              alt="logo-light"><img class="img-fluid for-dark"
                              src="<?php echo e(asset('assets/images/logo/logo.png')); ?>" alt="logo-dark"></a></div>
                  ...
                  <div> <a class="toggle-sidebar" href="#"> <i class="iconly-Category icli"> </i></a>
                      <div class="d-flex align-items-center gap-2 ">
                          <h4 class="f-w-600">Welcome
                              ...
                              <?php echo e(\Illuminate\Support\Str::title(auth()->user()->last_name ?? '')); ?></h4><img
                              class="mt-0" src="<?php echo e(asset('assets/images/hand.gif')); ?>" alt="hand-gif">
                      </div>
                  </div>
                  ...
                  <ul class="nav-menus">
                      <li class="d-md-block d-none">
                          <div class="form search-form mb-0">
                              <div class="input-group"><span class="input-icon">
                                      <svg>
                                          <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#search-header')); ?>"></use>
                                      </svg>
                                      <input class="w-100" type="search" placeholder="Search"
                                          id="sidebar-search-input"></span>
                                  <div class="Typeahead-menu custom-scrollbar" id="search-results"></div>
                              </div>
                          </div>
                      </li>
                          ...
                          <div class="form search-form mb-0">
                              <div class="input-group"> <span class="input-show">
                                      ...
                                      <div id="searchInput">
                                          ...
                                          <div class="Typeahead-menu custom-scrollbar" id="results"></div>
                                      </div>
                                  </span></div>
                          </div>
                      </li>
                      ...
                      <li class="onhover-dropdown notification-down">
                          <div class="notification-box">
                              <svg>
                                  <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#notification-header')); ?>"></use>
                                          ...
                                          <div class="tab-content" id="pills-tabContent">
                                                          ...
                                                          <ul>
                                                              <li class="pr-0 pl-0 pb-3 pt-3">
                                                                  <div class="media"><img
                                                                          ...
                                                                          src="<?php echo e(asset('assets/images/other-images/receiver-img.jpg')); ?>"
                                                                          alt="">
                                                      ...
                                                      <ul>
                                                                  ...
                                                                  <div class="flex-grow-1">
                                                                      <div class="common-space user-id w-100">
                                                                          <div class="common-space w-100"> <a
                                                                                  class="f-w-500 f-12"
                                                                                  href="<?php echo e(route('admin.chat_private')); ?>">Robert
                                                                                  D. Hambly</a></div>
                                                                      </div>
                                                          ...
                                                          <li
                                                              ...
                                                              <div
                                                                  ...
                                                                  <div class="user-alerts flex-shrink-0"><img
                                                                          class="rounded-circle img-fluid img-40"
                                                                          src="<?php echo e(asset('assets/images/dashboard/user/7.jpg')); ?>"
                                                                          alt="user" /></div>
                                                                  <div class="flex-grow-1">
                                                                      <div class="common-space user-id w-100">
                                                                          <div class="common-space w-100"> <a
                                                                                  class="f-w-500 f-12"
                                                                                  href="<?php echo e(route('admin.chat_private')); ?>">Courtney
                                                                                  C. Strang</a></div>
                                                                      </div>
                                                              ...
                                                              <div
                                                                  ...
                                                                  <div class="flex-grow-1">
                                                                      <div class="common-space user-id w-100">
                                                                          <div class="common-space w-100"> <a
                                                                                  class="f-w-500 f-12"
                                                                                  href="<?php echo e(route('admin.chat_private')); ?>">Raye
                                                                                  T. Sipes</a></div>
                                                                      </div>
                                                                      <div><span class="f-w-500 f-light f-12">Hello
                                                              ...
                                                              <div
                                                                  ...
                                                                  <div class="flex-grow-1">
                                                                      <div class="common-space user-id w-100">
                                                                          <div class="common-space w-100"> <a
                                                                                  class="f-w-500 f-12"
                                                                                  href="<?php echo e(route('admin.chat_private')); ?>">Henry
                                                                                  S. Miller</a></div>
                                                                      </div>
                                                  ...
                                                  <div class="cart-dropdown mt-4">
                                                      <ul>
                                                          <li class="pr-0 pl-0 pb-3">
                                                              <div class="media"><img
                                                                  ...
                                                                  <div class="media-body"><a class="f-light f-w-500"
                                                                          href="<?php echo e(route('admin.product')); ?>">Furniture
                                                                          Chair for Home</a>
                                                                      <div class="qty-box">
                                                                          <div class="input-group"> <span
                                                                                  class="input-group-prepend">
                                                          ...
                                                          <li class="mb-3 total"><a
                                                                  href="<?php echo e(route('admin.checkout')); ?>">
                                                                  <h6 class="mb-0">
                                              ...
                                              <div class="card-footer pb-0 pr-0 pl-0">
                                                  <div class="text-center"> <a class="f-w-700"
                                                          href="<?php echo e(route('admin.chat_private')); ?>">
                      ...
                      <li class="profile-nav onhover-dropdown">
                          <div class="media profile-media">
                              ...
                              <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($image)): ?>
                                  <img src="<?php echo e($image->getUrl()); ?>" alt="Image" class="b-r-10">
                              <?php else: ?>
                                  <img class="b-r-10" src="<?php echo e(asset('assets/images/dashboard/profile.png')); ?>"
                                      alt="">
                              <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                              <div class="media-body d-xxl-block d-none box-col-none">
                                  <div class="d-flex align-items-center gap-2">
                                      <span><?php echo e(ucfirst(auth()?->user()?->first_name)); ?> </span><i
                                          class="middle fa fa-angle-down"> </i>
                                  </div>
                                  <p class="mb-0 font-roboto"><?php echo e(ucfirst(str_replace('_', ' ', auth()?->user()->role ?? ''))); ?></p>
                              </div>
                          </div>
                          <ul class="profile-dropdown onhover-show-div">
                              <li><a href="<?php echo e(route('admin.user.edit-profile', auth()->user()->role ?? 'user')); ?>"><i
                                          data-feather="user"></i><span>My Profile</span></a>
                              </li>
                              <li><a href="<?php echo e(route('admin.letter_box')); ?>"><i
                                          data-feather="mail"></i><span>Inbox</span></a></li>
                              <li> <a href="<?php echo e(route('admin.settings.index')); ?>"> <i
      ...
      <!-- Page Header Ends-->
<?php /**PATH /Users/dimitar/Desktop/Clients/FreelanceProjects/Croatia-Admin/themeforest-XMp4qKjR-riho-laravel-admin-template/riho-laravel-1.0.1/resources/views/layouts/simple/header.blade.php ENDPATH**/ ?>