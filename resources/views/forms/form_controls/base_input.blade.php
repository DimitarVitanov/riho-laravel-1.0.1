                                ...
                                <div class="col">
                                    <div class="mb-3">
                                        <label class="form-label" for="exampleFormControlSelect12">Select your favorite
                                            roman number</label>
                                        <select class="form-select btn-square digits custom-scrollbar" id="exampleFormControlSelect12">
                                            <option>I </option>
                                            <option>II </option>
                                            <option>III</option>
                                            <option>IV </option>
                                ...
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select btn-pill digits" id="exampleFormControlSelect7">
                                            <option>Tivo</option>
                                            <option>{{ $settings['general']['site_name'] }}</option>
                                            <option>Roxo</option>
                                            <option>Oslo</option>
                                            <option>Voxo</option>
                                ...
                                <div class="col">
                                    <div class="mb-3">
                                        <label class="form-label" for="exampleFormControlSelect17">Select your favorite
                                            pixelstrap theme</label>
                                        <select class="form-select input-air-primary digits custom-scrollbar"
