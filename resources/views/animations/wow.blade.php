                    ...
                    <div class="card-body">
                        <div>
                            <div class="line">
                                ...
                                <pre class="mb-0 custom-scrollbar">&lt;section class="wow slideInLeft" data-wow-duration="2s" data-wow-delay="5s"&gt;<br /> &lt;/section&gt;<br /> &lt;section class="wow slideInRight" data-wow-offset="10" data-wow-iteration="10"&gt;<br /> &lt;/section&gt;</pre>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div>
                            <div class="line">
                                ...
                                <pre class="mb-0 custom-scrollbar">wow = new WOW(<br /> {<br /> boxClass: 'wow', // default<br /> animateClass: 'animated', // default<br /> offset: 0, // default<br /> mobile: true, // default<br /> live: true // default<br /> }<br /> )<br /> wow.init();                    </pre>
                                <!-- Page Body Ends                   -->
