...
.original-hero{background:#0A0B0D url('https://app.villabit.ai/villa-ready-assets/lines.webp') center/cover no-repeat;}
...
<div class="original-hero-media" onclick="openVideoViewer()" style="cursor:pointer;"><img alt="360 degree drone view preview" src="https://app.villabit.ai/storage/villa-ready/gallery/eJdXoVJHDlZeD3NThGzwFxCnX5Nd37Y2pW5hetzA.jpg"/><span class="media-label">360° Drone View ▶</span></div>
</div>
</section>
...
<img alt="Villa visualization" class="wide-image" onclick="openViewer(this.src)" src="https://app.villabit.ai/villa-ready-assets/mainVilla.png"/>
...
<div class="modal-viewer" id="videoViewer"><span class="modal-close" onclick="closeVideoViewer()">×</span><video id="droneVideo" controls autoplay loop style="max-width:95vw;max-height:90vh;border-radius:12px;"><source src="https://app.villabit.ai/villa-ready-assets/MilnaDroneAerial.mp4" type="video/mp4"></video></div>
<script>
