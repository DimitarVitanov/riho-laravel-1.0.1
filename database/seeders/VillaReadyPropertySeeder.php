...
The elevated position offers sea views, privacy, easy road access, and proximity to everything needed for holidays, private living, or rental use. The development includes four residential buildings with modern apartments, swimming pools, private outdoor areas, garages and storage.',
            ...
            'building_1_description' => 'Building 1 features 6 premium apartments across three floors with sea views and modern finishes.',
            'building_2_description' => 'Building 2 mirrors Building 1 with 6 apartments, offering the same high-quality construction and layouts.',
            'building_3_description' => 'Building 3 is a slightly smaller villa with 6 apartments, perfect for those seeking a more intimate setting.',
            'building_4_description' => 'Building 4 completes the chain with 6 apartments, positioned for optimal privacy and views.',
        ]);
