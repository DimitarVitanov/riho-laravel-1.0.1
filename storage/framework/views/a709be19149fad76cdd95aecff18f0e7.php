                            ...
                            <table class="display" id="basic-6">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="media"><img class="rounded-circle img-30 me-3"
                                                    src="<?php echo e(asset('assets/images/user/3.png')); ?>"
                                                    alt="Generic placeholder image">
                                                <div class="media-body align-self-center">
                                                    <div>Ashton Cox</div>
                                                </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="media"><img class="rounded-circle img-30 me-3"
                                                    src="<?php echo e(asset('assets/images/user/4.jpg')); ?>"
                                                    alt="Generic placeholder image">
                                                <div class="media-body align-self-center">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="media"><img class="rounded-circle img-30 me-3"
                                                    src="<?php echo e(asset('assets/images/user/6.jpg')); ?>"
                                                    alt="Generic placeholder image">
                                                <div class="media-body align-self-center">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="media"><img class="rounded-circle img-30 me-3"
                                                    src="<?php echo e(asset('assets/images/user/7.jpg')); ?>"
                                                    alt="Generic placeholder image">
                                                <div class="media-body align-self-center">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="media"><img class="rounded-circle img-30 me-3"
                                                    src="<?php echo e(asset('assets/images/user/9.jpg')); ?>"
                                                    alt="Generic placeholder image">
                                                <div class="media-body align-self-center">
...
<?php echo $__env->make('layouts.simple.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/dimitar/Desktop/Clients/FreelanceProjects/Croatia-Admin/themeforest-XMp4qKjR-riho-laravel-admin-template/riho-laravel-1.0.1/resources/views/support_ticket.blade.php ENDPATH**/ ?>