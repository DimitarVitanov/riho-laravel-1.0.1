    ...
    <div class="card">
        ...
        <div class="card-body">
            <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:13px;">
                ...
                <div>
                    <label class="form-label">Uniqueness Status</label>
                    <div class="form-control" style="background:var(--soft);">
                        <span style="font-weight:750;">{{ \App\Http\Controllers\Agency\AgencySettingsController::uniquenessCheckMethods()[$profile->uniqueness_check_method ?? 'villabit_ai'] ?? 'Villa Bit AI checked & manually approved' }}</span>
                    </div>
                </div>
                <div>
