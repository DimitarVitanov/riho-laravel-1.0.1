<?php $__env->startSection('css'); ?>
    ...
    <!-- Range slider css-->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/css/vendors/rangeslider/rSlider.min.css')); ?>">
            ...
            <div class="col-xxl-9 box-col-12">
                <div class="row">
                                ...
                                <div class="project-details">
                                    ...
                                    <div class="product-sub bg-primary-light">
                                        <svg class="invoice-icon">
                                            <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#color-swatch')); ?>"></use>
                                        </svg>
                                    </div>
                                </div>
                                <ul class="bubbles">
                            ...
                            <div class="card-body total-Progress border-b-warning border-2"> <span
                                ...
                                <div class="project-details">
                                    ...
                                    <div class="product-sub bg-warning-light">
                                        <svg class="invoice-icon">
                                            <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#tick-circle')); ?>"></use>
                                        </svg>
                                    </div>
                                </div>
                                <ul class="bubbles">
                            ...
                            <div class="card-body total-Complete border-b-secondary border-2"><span
                                ...
                                <div class="project-details">
                                    ...
                                    <div class="product-sub bg-secondary-light">
                                        <svg class="invoice-icon">
                                            <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#add-square')); ?>"></use>
                                        </svg>
                                    </div>
                                </div>
                                <ul class="bubbles">
                            ...
                            <div class="card-body total-upcoming"><span class="f-light f-w-500 f-14">Upcoming</span>
                                <div class="project-details">
                                    ...
                                    <div class="product-sub bg-light-light">
                                        <svg class="invoice-icon">
                                            <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#edit-2')); ?>"></use>
                                        </svg>
                                    </div>
                                </div>
                                <ul class="bubbles">
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-header card-no-border total-revenue">
                                <h4>Today Work</h4><a href="<?php echo e(route('admin.product')); ?>">View All </a>
                            </div>
                            <div class="card-body pt-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><span class="f-w-500 f-light d-block f-12 mb-1">App Design</span><a
                                                        class="f-w-500 f-14" href="<?php echo e(route('admin.product')); ?>">NFT
                                                        Illustration...</a>
                                                </td>
                                                <td> <span class="f-w-500 f-light d-block f-12 mb-1">Assigned to</span><a
                                                        class="f-w-500 f-14" href="<?php echo e(route('admin.product')); ?>">Cody
                                                        Fisher</a></td>
                                                <td><span class="f-w-500 f-light d-block f-12 mb-1">Days Left</span><a
                                                        class="f-w-500 f-14" href="<?php echo e(route('admin.product')); ?>">02</a></td>
                                                <td class="text-end">
                                            ...
                                            <tr>
                                                ...
                                                <td> <span class="f-w-500 f-light d-block f-12 mb-1">Arlene McCoy</span><a
                                                        class="f-w-500 f-14" href="<?php echo e(route('admin.product')); ?>">Assigned
                                                        to</a></td>
                                                <td><span class="f-w-500 f-light d-block f-12 mb-1">Days Left</span><a
                                                        class="f-w-500 f-14" href="<?php echo e(route('admin.product')); ?>">12</a></td>
                                                <td class="text-end">
                                                    <div class="badge-light-primary product-sub badge rounded-pill ">
                                                        <span>High</span>
                                                    </div>
                                            ...
                                            <tr>
                                                <td><span class="f-w-500 f-light d-block f-12 mb-1">Web Design</span><a
                                                        class="f-w-500 f-14" href="<?php echo e(route('admin.product')); ?>">Appron’s 3D
                                                        Co...</a>
                                                </td>
                                                <td> <span class="f-w-500 f-light d-block f-12 mb-1">Assigned to</span><a
                                                        class="f-w-500 f-14" href="<?php echo e(route('admin.product')); ?>">Kristin
                                                        Watson</a></td>
                                                <td><span class="f-w-500 f-light d-block f-12 mb-1">Days Left</span><a
                                                        class="f-w-500 f-14" href="<?php echo e(route('admin.product')); ?>">12</a></td>
                                                <td class="text-end">
                                            ...
                                            <tr>
                                                <td><span class="f-w-500 f-light d-block f-12 mb-1">Desktop App</span><a
                                                        class="f-w-500 f-14" href="<?php echo e(route('admin.product')); ?>">Rental Car</a>
                                                </td>
                                                <td> <span class="f-w-500 f-light d-block f-12 mb-1">Assigned to</span><a
                                                        class="f-w-500 f-14" href="<?php echo e(route('admin.product')); ?>">Darlene
                                                        Robertson</a>
                                                </td>
                                                <td><span class="f-w-500 f-light d-block f-12 mb-1">Days Left</span><a
                                                        class="f-w-500 f-14" href="<?php echo e(route('admin.product')); ?>">05</a></td>
                                                <td class="text-end">
                                            ...
                                            <tr>
                                                <td><span class="f-w-500 f-light d-block f-12 mb-1">Template
                                                        ...
                                                        href="<?php echo e(route('admin.product')); ?>">E-commerce</a></td>
                                                <td> <span class="f-w-500 f-light d-block f-12 mb-1">Assigned to</span><a
                                                        class="f-w-500 f-14" href="<?php echo e(route('admin.product')); ?>">Wade
                                                        Warren</a></td>
                                                <td><span class="f-w-500 f-light d-block f-12 mb-1">Days Left</span><a
                                                        class="f-w-500 f-14" href="<?php echo e(route('admin.product')); ?>">31</a></td>
                                                <td class="text-end">
                                                    <div class="badge-light-primary product-sub badge rounded-pill ">
                                                        <span>High</span>
                                                    </div>
                                            ...
                                            <tr>
                                                <td><span class="f-w-500 f-light d-block f-12 mb-1">App Design</span><a
                                                        class="f-w-500 f-14" href="<?php echo e(route('admin.product')); ?>">Food
                                                        Delivery</a></td>
                                                <td> <span class="f-w-500 f-light d-block f-12 mb-1">Assigned to</span><a
                                                        class="f-w-500 f-14" href="<?php echo e(route('admin.product')); ?>">Smith John</a>
                                                </td>
                                                <td><span class="f-w-500 f-light d-block f-12 mb-1">Days Left</span><a
                                                        class="f-w-500 f-14" href="<?php echo e(route('admin.product')); ?>">20</a></td>
                                                <td class="text-end">
                                                    <div class="badge-light-warning product-sub badge rounded-pill ">
                                                        <span>Medium</span>
                                                    </div>
                        ...
                        <div class="card">
                            <div class="card-header card-no-border total-revenue">
                                <h4>Important Project List</h4><a class="d-none d-sm-block"
                                    href="<?php echo e(route('admin.product')); ?>">View
                                    All</a>
                            </div>
                            <div class="card-body pt-0 row important-project">
                                    ...
                                    <div class="projectlist-card">
                                        <div class="projectlist">
                                            <div class="project-data"><img class="nft-img img-fluid"
                                                    src="<?php echo e(asset('assets/images/dashboard-2/category/1.png')); ?>"
                                                    alt="nft">
                                                <div> <a class="f-14 f-w-500 d-block" href="<?php echo e(route('admin.product')); ?>">Net
                                                        Banking
                                        ...
                                        <div class="project-comment">
                                                    ...
                                                    <div class="customers d-inline-block avatar-group">
                                                        <ul>
                                                            <li class="d-inline-block"><img class="img-25 rounded-circle"
                                                                    src="<?php echo e(asset('assets/images/user/18.png')); ?>"
                                                                    alt="">
                                                            </li>
                                                            <li class="d-inline-block"><img class="img-25 rounded-circle"
                                                                    src="<?php echo e(asset('assets/images/user/15.png')); ?>"
                                                                    alt="">
                                                            </li>
                                                            <li class="d-inline-block"><img class="img-25 rounded-circle"
                                                                    src="<?php echo e(asset('assets/images/user/19.png')); ?>"
                                                                    alt="">
                                                            </li>
                                                            <li class="d-inline-block"><img class="img-25 rounded-circle"
                                                                    src="<?php echo e(asset('assets/images/user/17.png')); ?>"
                                                                    alt="">
                                                            </li>
                                            ...
                                            <div class="project-comment-icon">
                                                <div class="project-link">
                                                    <svg>
                                                        <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#messages-2')); ?>">
                                                        </use>
                                                    </svg><span>18 </span>
                                                </div>
                                                <div class="project-link">
                                                    <svg>
                                                        <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#paperclip')); ?>">
                                                        </use>
                                                    </svg><span>2 </span>
                                                </div>
                                            </div>
                                        ...
                                        <div class="project-meeting-details">
                                            ...
                                            <div class="project-meeting-time"><a class="f-14 f-w-500 "
                                                    href="<?php echo e(route('admin.calendar_basic')); ?>">2 Nov 23,10:00 AM</a><a
                                                    class="f-14 f-w-500 " href="<?php echo e(route('admin.calendar_basic')); ?>">8 Nov
                                                    23,09:45 AM</a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-4 col-md-6 box-col-6">
                                    <div class="projectlist-card">
                                        <div class="projectlist">
                                            <div class="project-data"><img class="nft-img img-fluid"
                                                    src="<?php echo e(asset('assets/images/dashboard-2/category/2.png')); ?>"
                                                    alt="nft">
                                                <div><a class="f-14 f-w-500 d-block" href="<?php echo e(route('admin.product')); ?>">NFT
                                            ...
                                            <div class="avatar-showcase">
                                                <div class="avatars">
                                                    <div class="customers d-inline-block avatar-group">
                                                        <ul>
                                                            <li class="d-inline-block"><img class="img-25 rounded-circle"
                                                                    src="<?php echo e(asset('assets/images/user/24.png')); ?>"
                                                                    alt="">
                                                            </li>
                                                            <li class="d-inline-block"><img class="img-25 rounded-circle"
                                                                    src="<?php echo e(asset('assets/images/user/21.png')); ?>"
                                                                    alt="">
                                                            </li>
                                                            <li class="d-inline-block"><img class="img-25 rounded-circle"
                                                                    src="<?php echo e(asset('assets/images/user/23.png')); ?>"
                                                                    alt="">
                                                            </li>
                                                            <li class="d-inline-block"><img class="img-25 rounded-circle"
                                                                    src="<?php echo e(asset('assets/images/user/22.png')); ?>"
                                                                    alt="">
                                                            </li>
                                                            <li class="d-inline-block">
                                ...
                                <div class="col-xl-4 box-col-none marketing-app-card">
                                    <div class="projectlist-card">
                                        <div class="projectlist">
                                            <div class="project-data"> <img class="nft-img img-fluid"
                                                    src="<?php echo e(asset('assets/images/dashboard-2/category/3.png')); ?>"
                                                    alt="nft">
                                                <div><a class="f-14 f-w-500 d-block"
                                                        href="<?php echo e(route('admin.product')); ?>">Marketing App
                                            ...
                                            <div class="avatar-showcase">
                                                <div class="avatars">
                                                    <div class="customers d-inline-block avatar-group">
                                                        <ul>
                                                            <li class="d-inline-block"><img class="img-25 rounded-circle"
                                                                    src="<?php echo e(asset('assets/images/user/25.png')); ?>"
                                                                    alt="">
                                                            </li>
                                                            <li class="d-inline-block"><img class="img-25 rounded-circle"
                                                                    src="<?php echo e(asset('assets/images/user/26.png')); ?>"
                                                                    alt="">
                                                            </li>
                                                            <li class="d-inline-block"><img class="img-25 rounded-circle"
                                                                    src="<?php echo e(asset('assets/images/user/27.png')); ?>"
                                                                    alt="">
                                                            </li>
                                                            <li class="d-inline-block"> <img class="img-25 rounded-circle"
                                                                    src="<?php echo e(asset('assets/images/user/28.png')); ?>"
                                                                    alt="">
                                                            </li>
                                                            <li class="d-inline-block">
                                        ...
                                        <div class="project-meeting-details">
                                            ...
                                            <div class="project-meeting-time"> <a class="f-14 f-w-500 "
                                                    href="<?php echo e(route('admin.calendar_basic')); ?>">6 Nov 23,2:56 PM</a><a
                                                    class="f-14 f-w-500 " href="<?php echo e(route('admin.calendar_basic')); ?>">10 Nov 23,
                                                    7:12
                                                    AM</a></div>
                                        </div>
                                    </div>
                    ...
                    <div class="col-xxl-12">
                        <div class="card recent-order">
                            <div class="card-header card-no-border total-revenue">
                                ...
                                <div class="header-top"></div><a href="<?php echo e(route('admin.product')); ?>">View All </a>
                            </div>
                            <div class="card-body pt-0">
                                    ...
                                    <table class="order-table project-table w-100">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <div class="project-comment  d-flex gap-2">
                                                        ...
                                                        <div> <a class="f-w-500 f-14 " href="<?php echo e(route('admin.product')); ?>">Pet
                                                                App
                                                                Design</a>
                                                            <div class="project-comment-icon">
                                                                <div class="project-link">
                                                                    <svg>
                                                                        <use
                                                                            href="<?php echo e(asset('assets/svg/icon-sprite.svg#messages-2')); ?>">
                                                                        </use>
                                                                ...
                                                                <div class="project-link">
                                                                    <svg>
                                                                        <use
                                                                            href="<?php echo e(asset('assets/svg/icon-sprite.svg#paperclip')); ?>">
                                                                        </use>
                                                ...
                                                <td>
                                                    <div class="product-sub"><a class="f-w-500 f-14 "
                                                            href="<?php echo e(route('admin.product')); ?>">Darrell Steward</a><span
                                                            class="f-w-500 f-light f-12 d-block">darrells@example.com</span>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="product-sub"><a class="f-w-500 f-14 "
                                                            href="<?php echo e(route('admin.product')); ?>">15 Nov, 2024</a><span
                                                            class="f-w-500 f-light f-12 d-block">8 Days Left</span></div>
                                                </td>
                                                <td>
                                                    <div class="product-sub"><a class="f-w-500 f-14 "
                                                            href="<?php echo e(route('admin.product')); ?>">Team Roha</a><span
                                                    ...
                                                    <div class="product-sub">
                                                        <div class="dropdown">
                                                            <div id="dropdownMenuButtonicon11" data-bs-toggle="dropdown"
                                                                ...
                                                                <svg class="invoice-icon">
                                                                    <use
                                                                        href="<?php echo e(asset('assets/svg/icon-sprite.svg#more-horizontal')); ?>">
                                                                    </use>
                                                                </svg>
                                                            </div>
                                                            <div class="dropdown-menu dropdown-menu-end"
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="project-comment  d-flex gap-2">
                                                        ...
                                                        <div> <a class="f-w-500 f-14 "
                                                                href="<?php echo e(route('admin.product')); ?>">Chain Desktop
                                                                App</a>
                                                            <div class="project-comment-icon">
                                                                <div class="project-link">
                                                                    <svg>
                                                ...
                                                <td>
                                                    <div class="product-sub"><a class="f-w-500 f-14 "
                                                            href="<?php echo e(route('admin.product')); ?>">Eleanor Pena</a><span
                                                            class="f-w-500 f-light f-12 d-block">pena12@example.com</span>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="product-sub"><a class="f-w-500 f-14 "
                                                            href="<?php echo e(route('admin.product')); ?>">20 Nov, 2024</a><span
                                                            class="f-w-500 f-light f-12 d-block">13 Days Left</span></div>
                                                </td>
                                                <td>
                                                    <div class="product-sub"><a class="f-w-500 f-14 "
                                                            href="<?php echo e(route('admin.product')); ?>">Team Suresh</a><span
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="project-comment  d-flex gap-2">
                                                        ...
                                                        <div> <a class="f-w-500 f-14 "
                                                                href="<?php echo e(route('admin.product')); ?>">Business Web
                                                                Design</a>
                                                            <div class="project-comment-icon">
                                                                <div class="project-link">
                                                                    <svg>
                                                ...
                                                <td>
                                                    <div class="product-sub"><a class="f-w-500 f-14 "
                                                            href="<?php echo e(route('admin.product')); ?>">Robert Fox</a><span
                                                            class="f-w-500 f-light f-12 d-block">foxxxx8s@example.com</span>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="product-sub"><a class="f-w-500 f-14 "
                                                            href="<?php echo e(route('admin.product')); ?>">22 Nov, 2024</a><span
                                                            class="f-w-500 f-light f-12 d-block">15 Days Left</span></div>
                                                </td>
                                                <td>
                                                    <div class="product-sub"><a class="f-w-500 f-14 "
                                                            href="<?php echo e(route('admin.product')); ?>">Team Liza</a><span
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="project-comment  d-flex gap-2">
                                                        ...
                                                        <div> <a class="f-w-500 f-14 " href="<?php echo e(route('admin.product')); ?>">NFT
                                                                App
                                                                Design</a>
                                                            <div class="project-comment-icon">
                                                                <div class="project-link">
                                                ...
                                                <td>
                                                    <div class="product-sub"><a class="f-w-500 f-14 "
                                                            href="<?php echo e(route('admin.product')); ?>">Arlene McCoy</a><span
                                                            class="f-w-500 f-light f-12 d-block">arlene78@example.com</span>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="product-sub"><a class="f-w-500 f-14 "
                                                            href="<?php echo e(route('admin.product')); ?>">28 Nov, 2024</a><span
                                                            class="f-w-500 f-light f-12 d-block">21 Days Left</span></div>
                                                </td>
                                                <td>
                                                    <div class="product-sub"><a class="f-w-500 f-14 "
                                                            href="<?php echo e(route('admin.product')); ?>">Team Sulekha</a><span
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="project-comment  d-flex gap-2">
                                                        ...
                                                        <div> <a class="f-w-500 f-14 "
                                                                href="<?php echo e(route('admin.product')); ?>">Digital Avtar
                                                                Web Design</a>
                                                            <div class="project-comment-icon">
                                                                <div class="project-link">
                                                                    <svg>
                                                ...
                                                <td>
                                                    <div class="product-sub"><a class="f-w-500 f-14 "
                                                            href="<?php echo e(route('admin.product')); ?>">Courtney Henry</a><span
                                                            class="f-w-500 f-light f-12 d-block">henry45@example.com</span>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="product-sub"><a class="f-w-500 f-14 "
                                                            href="<?php echo e(route('admin.product')); ?>">2 Dec, 2024</a><span
                                                            class="f-w-500 f-light f-12 d-block">25 Days Left</span></div>
                                                </td>
                                                <td>
                                                    <div class="product-sub"><a class="f-w-500 f-14 "
                                                            href="<?php echo e(route('admin.product')); ?>">Team Shreena</a><span
                                                            class="f-w-500 f-light f-12 d-block">12 Member</span></div>
                                                </td>
                                                <td>
                                                    <div
                                                ...
                                                <td class="client-list">
                                                    <div class="user-id">
                                                        <div class="avatars me-2">
                                                            <div class="avatar"><img class="img-50 rounded-circle"
                                                                    src="<?php echo e(asset('assets/images/user/29.png')); ?>"
                                                                    alt="#">
                                                    ...
                                                    <div class="user-comment w-100">
                                                        ...
                                                        <div class="product-sub">
                                                            <svg class="invoice-icon">
                                                                <use
                                                                    href="<?php echo e(asset('assets/svg/icon-sprite.svg#messages-3')); ?>">
                                                                </use>
                                                            </svg>
                                                        </div>
                                                    </div>
                                            ...
                                            <tr>
                                                <td class="client-list">
                                                    <div class="user-id">
                                                        <div class="avatars me-2">
                                                            <div class="avatar"><img class="img-50 rounded-circle"
                                                                    src="<?php echo e(asset('assets/images/user/30.png')); ?>"
                                                                    alt="#">
                                                                <div class="status status-dnd bg-warning"></div>
                                                            </div>
                                                        </div>
                                            ...
                                            <tr>
                                                <td class="client-list">
                                                    <div class="user-id">
                                                        <div class="avatars me-2">
                                                            <div class="avatar"> <img class="img-50 rounded-circle"
                                                                    src="<?php echo e(asset('assets/images/user/33.png')); ?>"
                                                                    alt="#">
                                                                <div class="status status-dnd bg-warning"> </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <tr>
                                                <td class="client-list">
                                                    <div class="user-id">
                                                        <div class="avatars me-2">
                                                            <div class="avatar"> <img class="img-50 rounded-circle"
                                                                    src="<?php echo e(asset('assets/images/user/31.png')); ?>"
                                                                    alt="#">
                                                            </div>
                                                        </div>
                                                        <div class="product-sub"> <a class="f-14 f-w-500 "
                                            ...
                                            <tr>
                                                <td class="client-list">
                                                    <div class="user-id">
                                                        <div class="avatars me-2">
                                                            <div class="avatar"><img class="img-50 rounded-circle"
                                                                    src="<?php echo e(asset('assets/images/user/32.png')); ?>"
                                                                    alt="#">
                                                            </div>
                                                        </div>
                                                        <div class="product-sub"><a class="f-14 f-w-500 "
            ...
            <div class="col-xxl-3 d-xxl-block d-none activity-group box-col-none">
                <div class="card add-project-link">
                    ...
                    <div class="categories-content"> <span class="text-truncate col-8 f-12 d-block mb-2">Let’s add work to
                            your space</span><a href="<?php echo e(route('admin.create_project')); ?>">+Add Project </a></div>
                </div>
                <div class="row">
                    <div class="col-xl-12">
                        <div class="card">
                                    ...
                                    <ul>
                                        <li class="activity-log">
                                            <div class="d-flex align-items-start gap-2"><img
                                                    ...
                                                    src="<?php echo e(asset('assets/images/user/26.png')); ?>" alt="user" />
                                                <div>
                                                    <div class="common-space user-id">
                                                        <h6> <a class="f-w-500 f-12"
                                                                href="<?php echo e(route('admin.user_profile')); ?>">Jenny
                                                    ...
                                                    <div class="d-flex mb-2"><span class="f-light f-w-500 f-12">Commented
                                                            ...
                                                            href="<?php echo e(route('admin.blog')); ?>"> NFT
                                                        ...
                                                        href="<?php echo e(route('admin.user_profile')); ?>"></a>
                                                </div>
                                            </div>
                                        </li>
                                        <li class="activity-log">
                                            <div class="d-flex align-items-start gap-2"><img
                                                    class="activity-log-img rounded-circle img-fluid me-2"
                                                    src="<?php echo e(asset('assets/images/user/34.png')); ?>" alt="user" />
                                                <div>
                                                    <div class="common-space user-id">
                                                        <h6> <a class="f-w-500 f-12"
                                                                href="<?php echo e(route('admin.user_profile')); ?>">Darlene
                                                    ...
                                                    <div class="d-flex mb-2"><span class="f-light f-w-500 f-12">Shared
                                                            ...
                                                            href="<?php echo e(route('admin.blog')); ?>">Barkha</a></div><span
                                        ...
                                        <li class="activity-log">
                                            <div class="d-flex align-items-start gap-2"><img
                                                    class="activity-log-img rounded-circle img-fluid me-2"
                                                    src="<?php echo e(asset('assets/images/user/35.png')); ?>" alt="user" />
                                                <div>
                                                    <div class="common-space user-id">
                                                        <h6> <a class="f-w-500 f-12"
                                                                href="<?php echo e(route('admin.user_profile')); ?>">Seema
                                                                Joshi</a></h6><span class="f-light f-w-500 f-12">Today
                                                            10:42 AM</span>
                                                    </div>
                                                    <div class="d-flex mb-2"><span class="f-light f-w-500 f-12">Meeting :
                                                        </span><a class="f-w-500 f-12" href="<?php echo e(route('admin.blog')); ?>">Eva
                                                            Website</a>
                                                        ...
                                                        class="f-12 f-w-500 username"
                                                        href="<?php echo e(route('admin.user_profile')); ?>">@barkha_singh</a>
                                                </div>
                                            </div>
                                        </li>
                                        <li class="activity-log">
                                            <div class="d-flex align-items-start gap-2"><img
                                                    class="activity-log-img rounded-circle img-fluid me-2"
                                                    src="<?php echo e(asset('assets/images/user/44.png')); ?>" alt="user" />
                                                <div>
                                                    <div class="common-space user-id">
                                                        <h6> <a class="f-w-500 f-12"
                                                                href="<?php echo e(route('admin.user_profile')); ?>">Elara
                                        ...
                                        <li class="activity-log">
                                            <div class="d-flex align-items-start gap-2"><img
                                                    class="activity-log-img rounded-circle img-fluid me-2"
                                                    src="<?php echo e(asset('assets/images/user/38.png')); ?>" alt="user" />
                                                <div>
                                                    <div class="common-space user-id">
                                                        <h6> <a class="f-w-500 f-12"
                                                                href="<?php echo e(route('admin.user_profile')); ?>">Arya
                                                    ...
                                                    <div class="d-flex mb-2"><span class="f-light f-w-500 f-12">Add new
                                                            ...
                                                            href="<?php echo e(route('admin.blog')); ?>">Pet
                    ...
                    <div class="col-xl-12 col-md-6">
                        <div class="card">
                            <div class="card-header card-no-border total-revenue card-title-underline">
                                <h4>Message</h4><a href="<?php echo e(route('admin.product')); ?>">+ New Message </a>
                            </div>
                            <div class="card-body pt-0">
                                    ...
                                    <ul>
                                        <li>
                                            <div class="activity-log"><img
                                                    class="activity-log-img rounded-circle img-fluid me-2"
                                                    src="<?php echo e(asset('assets/images/user/39.png')); ?>" alt="user" />
                                                <div class="status bg-warning"></div>
                                                <div class="activity-name">
                                                    <div>
                                                        <h6> <a class="f-w-500 f-14"
                                                                href="<?php echo e(route('admin.user_profile')); ?>">Maren
                                                    ...
                                                    <div class="product-sub">
                                                        <div class="dropdown">
                                                            <div id="dropdownMenuButtonicon21" data-bs-toggle="dropdown"
                                                                ...
                                                                <svg class="invoice-icon">
                                                                    <use
                                                                        href="<?php echo e(asset('assets/svg/icon-sprite.svg#more-vertical')); ?>">
                                                                    </use>
                                                                </svg>
                                                            </div>
                                                            <div class="dropdown-menu dropdown-menu-end"
                                        ...
                                        <li>
                                            <div class="activity-log"><img
                                                    class="activity-log-img rounded-circle img-fluid me-2"
                                                    src="<?php echo e(asset('assets/images/user/40.png')); ?>" alt="user" />
                                                <div class="status bg-undefined"></div>
                                                <div class="activity-name">
                                                    <div>
                                                        <h6> <a class="f-w-500 f-14"
                                                                href="<?php echo e(route('admin.user_profile')); ?>">Brooklyn
                                        ...
                                        <li>
                                            <div class="activity-log"><img
                                                    class="activity-log-img rounded-circle img-fluid me-2"
                                                    src="<?php echo e(asset('assets/images/user/41.png')); ?>" alt="user" />
                                                <div class="status bg-warning"></div>
                                                <div class="activity-name">
                                                    <div>
                                                        <h6> <a class="f-w-500 f-14"
                                                                href="<?php echo e(route('admin.user_profile')); ?>">Floyd
                                        ...
                                        <li>
                                            <div class="activity-log"><img
                                                    class="activity-log-img rounded-circle img-fluid me-2"
                                                    src="<?php echo e(asset('assets/images/user/42.png')); ?>" alt="user" />
                                                <div class="status bg-undefined"></div>
                                                <div class="activity-name">
                                                    <div>
                                                        <h6> <a class="f-w-500 f-14"
                                                                href="<?php echo e(route('admin.user_profile')); ?>">Dianne
                                        ...
                                        <li>
                                            <div class="activity-log"><img
                                                    class="activity-log-img rounded-circle img-fluid me-2"
                                                    src="<?php echo e(asset('assets/images/user/43.png')); ?>" alt="user" />
                                                <div class="status bg-warning"></div>
                                                <div class="activity-name">
                                                    <div>
                                                        <h6> <a class="f-w-500 f-14"
                                        ...
                                        <li>
                                            <div class="activity-log"><img
                                                    class="activity-log-img rounded-circle img-fluid me-2"
                                                    src="<?php echo e(asset('assets/images/user/45.png')); ?>" alt="user" />
                                                <div class="status bg-warning"></div>
                                                <div class="activity-name">
                                                    <div>
                                                        <h6> <a class="f-w-500 f-14"
                                                                href="<?php echo e(route('admin.user_profile')); ?>">Ralph
                                        ...
                                        <li>
                                            <div class="activity-log"><img
                                                    class="activity-log-img rounded-circle img-fluid me-2"
                                                    src="<?php echo e(asset('assets/images/user/15.png')); ?>" alt="user" />
                                                <div class="status bg-warning"></div>
                                                <div class="activity-name">
                                                    <div>
                                                        <h6> <a class="f-w-500 f-14"
                                                                href="<?php echo e(route('admin.user_profile')); ?>">Ronald
                                        ...
                                        <li>
                                            <div class="activity-log"><img
                                                    class="activity-log-img rounded-circle img-fluid me-2"
                                                    src="<?php echo e(asset('assets/images/user/47.png')); ?>" alt="user" />
                                                <div class="status bg-undefined"></div>
                                                <div class="activity-name">
                                                    <div>
                                                        <h6> <a class="f-w-500 f-14"
                                                                href="<?php echo e(route('admin.user_profile')); ?>">Courtney
                            ...
                            <div class="card-body pt-0 project-ideas-card">
                                <div class="project-card">
                                    <div><span class="f-22 f-w-500 text-center">Get more ideas for your important
                                            project</span>
                                        <div class="btn-showcase text-center"> <a href="<?php echo e(route('admin.pricing')); ?>">
...
<?php $__env->startSection('scripts'); ?>
    ...
    <!-- Range Slider js-->
    <script src="<?php echo e(asset('assets/js/range-slider/rSlider.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/rangeslider/rangeslider.js')); ?>"></script>
...
<?php echo $__env->make('layouts.simple.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/dimitar/Desktop/Clients/FreelanceProjects/Croatia-Admin/themeforest-XMp4qKjR-riho-laravel-admin-template/riho-laravel-1.0.1/resources/views/dashboards/project_dashboard.blade.php ENDPATH**/ ?>