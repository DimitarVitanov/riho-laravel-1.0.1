...
<div class="container-fluid affiliate-page">
    ...
    <div class="vb-card" style="margin-bottom:24px;text-align:center;padding:40px 24px;">
        <h2 style="font-size:28px;font-weight:800;color:#111827;margin-bottom:16px;line-height:1.2;">{{ __('messages.affiliate_hero_title') }}</h2>
        <p style="margin-bottom:8px;color:#6b7280;font-size:14px;line-height:1.7;max-width:680px;margin-left:auto;margin-right:auto;">{{ __('messages.affiliate_hero_subtitle') }}</p>
        <p style="margin-bottom:24px;color:#9ca3af;font-size:12px;">{{ __('messages.affiliate_hero_terms') }}</p>
        <div style="display:flex;justify-content:center;gap:40px;flex-wrap:wrap;">
            <div>
                <div style="font-size:26px;font-weight:700;color:#111827;">180</div>
                <div style="font-size:12px;color:#6b7280;text-transform:uppercase;letter-spacing:0.5px;">{{ __('messages.day_cookie') }}</div>
            </div>
            <div>
                <div style="font-size:26px;font-weight:700;color:#111827;">$10</div>
                <div style="font-size:12px;color:#6b7280;text-transform:uppercase;letter-spacing:0.5px;">{{ __('messages.min_payout') }}</div>
            </div>
            <div>
                <div style="font-size:26px;font-weight:700;color:#111827;">1st</div>
                <div style="font-size:12px;color:#6b7280;text-transform:uppercase;letter-spacing:0.5px;">{{ __('messages.monthly_payout') }}</div>
            </div>
        </div>
    </div>
