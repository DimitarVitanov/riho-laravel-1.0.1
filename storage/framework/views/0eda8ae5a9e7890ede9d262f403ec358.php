    ...
    <div class="container-fluid">
        <div class="row size-column">
                        ...
                        <div class="card boost-up-card overflow-hidden">
                            <div class="p-4">
                                ...
                                <div class="img-boostup"><img class="img-boostup-img-1"
                                        src="<?php echo e(asset('assets/images/dashboard-3/boostup1.png')); ?>" alt="boostup"><img
                                        class="img-boostup-img-2"
                                        src="<?php echo e(asset('assets/images/dashboard-3/boostup2.png')); ?>" alt="boostup"></div>
                                <div class="btn-showcase text-start"> <a href="<?php echo e(route('admin.pricing')); ?>">
                        ...
                        <div class="card">
                            <div class="card-header card-no-border total-revenue pb-0">
                                ...
                                <div class="icon-menu-header">
                                    <svg>
                                        <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#more-horizontal')); ?>"></use>
                                    </svg>
                                </div>
                            </div>
                            <div class="card-body pt-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="f-w-400 f-10"> <a class="line-clamp"
                                                        href="<?php echo e(route('admin.cart')); ?>">On Time
                                                        Delivery</a></td>
                                                <td>
                                            ...
                                            <tr>
                                                <td class="f-w-400 f-10"> <a class="line-clamp"
                                                        href="<?php echo e(route('admin.cart')); ?>">Delayed
                                                        Delivery</a></td>
                                                <td>
                                                    <div class="progress-value d-flex gap-2 align-items-center">
                                                        <div class="progress">
            ...
            <div class="col-xxl-4 col-md-6 box-col-6">
                <div class="card height-equal">
                    <div class="card-header card-no-border total-revenue">
                        <h4>Top Product </h4><a href="<?php echo e(route('admin.product')); ?>">View All </a>
                    </div>
                    <div class="card-body pt-0">
                            ...
                            <ul>
                                <li class="d-flex top-product gap-2">
                                    <div><img class="img-fluid product-img"
                                            src="<?php echo e(asset('assets/images/dashboard-3/product/1.png')); ?>"
                                            alt="product" />
                                    </div>
                                    <div class="w-100 d-flex justify-content-between align-items-center">
                                        <div class="product-details">
                                            <div><span class="badge rounded-pill badge-light text-dark">SKU90400</span>
                                                ...
                                                href="<?php echo e(route('admin.product')); ?>">Huawai Smart
                                ...
                                <li class="d-flex top-product gap-2">
                                    <div><img class="img-fluid product-img"
                                            src="<?php echo e(asset('assets/images/dashboard-3/product/2.png')); ?>"
                                            alt="product" />
                                    </div>
                                    <div class="w-100 d-flex justify-content-between align-items-center">
                                        <div class="product-details">
                                            <div><span class="badge rounded-pill badge-light text-dark">SKU78589</span>
                                                ...
                                                href="<?php echo e(route('admin.product')); ?>">Noise
                                                - Wireless
                                ...
                                <li class="d-flex top-product gap-2">
                                    <div><img class="img-fluid product-img"
                                            src="<?php echo e(asset('assets/images/dashboard-3/product/3.png')); ?>"
                                            alt="product" />
                                    </div>
                                    <div class="w-100 d-flex justify-content-between align-items-center">
                                        <div class="product-details">
                                            <div><span class="badge rounded-pill badge-light text-dark">SKU78599</span>
                                                ...
                                                href="<?php echo e(route('admin.product')); ?>">Men
                                                &amp; Women
                                ...
                                <li class="d-flex top-product gap-2">
                                    <div><img class="img-fluid product-img"
                                            src="<?php echo e(asset('assets/images/dashboard-3/product/4.png')); ?>"
                                            alt="product" />
                                    </div>
                                    <div class="w-100 d-flex justify-content-between align-items-center">
                                        <div class="product-details">
                                            <div><span class="badge rounded-pill badge-light text-dark">SKU78596</span>
                                                ...
                                                href="<?php echo e(route('admin.product')); ?>">Anime
                                                White Half
                                                Sleev
            ...
            <div class="col-xxl-3 col-sm-6 box-col-6">
                <div class="card height-equal">
                    <div class="card-header card-no-border total-revenue">
                        <h4>New User </h4><a href="<?php echo e(route('admin.product')); ?>">View All</a>
                    </div>
                    <div class="card-body pt-0">
                        <div class="new-user">
                            <ul>
                                <li>
                                    <div class="space-common d-flex user-name"><img
                                            ...
                                            src="<?php echo e(asset('assets/images/user/22.png')); ?>" alt="user" />
                                ...
                                <li>
                                    <div class="space-common d-flex user-name"><img
                                            class="img-40 rounded-circle img-fluid me-2"
                                            src="<?php echo e(asset('assets/images/user/28.png')); ?>" alt="user" />
                                        <div class="common-space w-100">
                                            <div>
                                ...
                                <li>
                                    <div class="space-common d-flex user-name"><img
                                            class="img-40 rounded-circle img-fluid me-2"
                                            src="<?php echo e(asset('assets/images/user/24.png')); ?>" alt="user" />
                                        <div class="common-space w-100">
                                            <div>
                                ...
                                <li>
                                    <div class="space-common d-flex user-name"><img
                                            class="img-40 rounded-circle img-fluid me-2"
                                            src="<?php echo e(asset('assets/images/user/49.png')); ?>" alt="user" />
                                        <div class="common-space w-100">
                                            <div>
            ...
            <div class="col-xxl-5 col-sm-6 box-col-6">
                <div class="card height-equal">
                    <div class="card-header card-no-border total-revenue pb-0">
                        <h4>Team Activity </h4><a href="<?php echo e(route('admin.product')); ?>">View All </a>
                    </div>
                    <div class="card-body pt-0">
                                                ...
                                                <div class="activity-data d-flex align-items-center gap-3">
                                                    <div class="common-space gap-2 ">
                                                        <div class="user-activity me-3"><img
                                                                ...
                                                                src="<?php echo e(asset('assets/images/user/50.png')); ?>"
                                                                alt="user"><a class="f-10 f-w-500 username"
                                                                href="<?php echo e(route('admin.edit_profile')); ?>">Floyd Miles</a>
                                                        </div>
                                            ...
                                            <div class="team-activity">
                                                <div class="activity-data d-flex align-items-center gap-3">
                                                    <div class="common-space gap-2 ">
                                                        <div class="user-activity me-3"><img
                                                                class="rounded-circle p-1 img-fluid me-3 img-50"
                                                                src="<?php echo e(asset('assets/images/user/51.png')); ?>"
                                                                alt="user"><a class="f-10 f-w-500 username"
                                                                href="<?php echo e(route('admin.edit_profile')); ?>">Ralph Edwards</a>
                                                        </div>
                                                ...
                                                <div class="activity-data d-flex align-items-center gap-3">
                                                    <div class="common-space gap-2 ">
                                                        <div class="user-activity me-3"><img
                                                                ...
                                                                alt="user"><a class="f-10 f-w-500 username"
                                                                href="<?php echo e(route('admin.edit_profile')); ?>">Esther Howard</a>
                                                        </div>
                                            ...
                                            <div class="team-activity">
                                                <div class="activity-data d-flex align-items-center gap-3">
                                                    <div class="common-space gap-2 ">
                                                        <div class="user-activity me-3"><img
                                                                class="rounded-circle p-1 img-fluid me-3 img-50"
                                                                src="<?php echo e(asset('assets/images/user/52.png')); ?>"
                                                                alt="user"><a class="f-10 f-w-500 username"
                                                                href="<?php echo e(route('admin.edit_profile')); ?>">Jacob Jones</a>
                                                        </div>
                                            ...
                                            <div class="team-activity">
                                                <div class="activity-data d-flex align-items-center gap-3">
                                                    <div class="common-space gap-2 ">
                                                        <div class="user-activity me-3"><img
                                                                class="rounded-circle p-1 img-fluid me-3 img-50"
                                                                src="<?php echo e(asset('assets/images/user/53.png')); ?>"
                                                                alt="user"><a class="f-10 f-w-500 username"
                                                                href="<?php echo e(route('admin.edit_profile')); ?>">Theresa Webb</a>
                                                        </div>
                                            ...
                                            <div class="team-activity">
                                                <div class="activity-data d-flex align-items-center gap-3">
                                                    <div class="common-space gap-2 ">
                                                        <div class="user-activity me-3"><img
                                                                class="rounded-circle p-1 img-fluid me-3 img-50"
                                                                src="<?php echo e(asset('assets/images/user/54.png')); ?>"
                                                                alt="user"><a class="f-10 f-w-500 username"
                                                                href="<?php echo e(route('admin.edit_profile')); ?>">Annette Black</a>
                                                        </div>
                                                        <div class="activity-time"><span class="f-light f-w-500 f-10">12
                                                                min ago</span></div>
                                                    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-footer">
                        <div class="common-space">
                            <div><a class="f-w-600 f-14 " href="<?php echo e(route('admin.default_dashboard')); ?>">Most Visited Day</a><span
                                    class="f-light f-w-500 f-14 d-block">Total 59.6k visits on Sunday </span></div>
                            <div class="visited-dropdown">
                                <svg class="mb-0">
                                    <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#arrow-down')); ?>"></use>
                                </svg>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-xxl-5 col-xl-6 box-col-6">
                <div class="card">
                    <div class="card-header card-no-border total-revenue">
                        <h4>Latest Transaction</h4><a href="<?php echo e(route('admin.product')); ?>">View All</a>
                    </div>
                    <div class="card-body pt-0">
                            ...
                            <table class=" w-100 tranaction-table">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="product-name"><a class=" f-14 f-w-500"
                                                    href="<?php echo e(route('admin.product')); ?>">Darrell Steward</a>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="product-name"><a class=" f-14 f-w-500"
                                                    href="<?php echo e(route('admin.product')); ?>">Floyd
                                                    Miles</a></div>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="product-name"><a class=" f-14 f-w-500"
                                                    href="<?php echo e(route('admin.product')); ?>">Ralph
                                                    Edwards</a>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="product-name"><a class=" f-14 f-w-500"
                                                    href="<?php echo e(route('admin.product')); ?>">Jerome
                                                    Bell</a></div>
                                        </td>
                                        <td class="f-14 f-w-500">16 Nov, 2024</td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="product-name"><a class=" f-14 f-w-500"
                                                    href="<?php echo e(route('admin.product')); ?>">Theresa Webb</a>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="product-name"><a class=" f-14 f-w-500"
                                                    href="<?php echo e(route('admin.product')); ?>">Courtney Henry</a>
                                            </div>
                                        </td>
...
<?php echo $__env->make('layouts.simple.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/dimitar/Desktop/Clients/FreelanceProjects/Croatia-Admin/themeforest-XMp4qKjR-riho-laravel-admin-template/riho-laravel-1.0.1/resources/views/admin/dashboard/index.blade.php ENDPATH**/ ?>