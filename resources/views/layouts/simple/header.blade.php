      ...
      <div class="page-header">
          <div class="header-wrapper row m-0">
                      ...
                      <div class="Typeahead Typeahead--twitterUsers">
                          <div class="u-posRelative">
                              <input class="demo-input Typeahead-input form-control-plaintext w-100" type="text"
                                  placeholder="Search {{ $settings['general']['site_name'] }} .." name="q" title="" autofocus>
              ...
              <div class="header-logo-wrapper col-auto p-0">
                  <div class="logo-wrapper"> <a href="{{ route('admin.default_dashboard') }}"><img
                              class="img-fluid for-light" src="{{ asset('assets/images/logo/logo_dark.png') }}"
                              alt="logo-light"><img class="img-fluid for-dark"
                              src="{{ asset('assets/images/logo/logo.png') }}" alt="logo-dark"></a></div>
                  ...
                  <div> <a class="toggle-sidebar" href="#"> <i class="iconly-Category icli"> </i></a>
                      <div class="d-flex align-items-center gap-2 ">
                          <h4 class="f-w-600">Welcome
                              ...
                              {{ \Illuminate\Support\Str::title(auth()->user()->last_name ?? '') }}</h4><img
                              class="mt-0" src="{{ asset('assets/images/hand.gif') }}" alt="hand-gif">
                      </div>
                  </div>
                  ...
                  <ul class="nav-menus">
                      ...
                      <li class="profile-nav onhover-dropdown">
                          ...
                          <ul class="profile-dropdown onhover-show-div">
                              <li><a href="{{ route('admin.user.edit-profile', auth()->user()->role ?? 'user') }}"><i
                                          data-feather="user"></i><span>My Profile</span></a>
                              </li>
                              <li><a href="{{ route('admin.letter_box') }}"><i
                                          data-feather="mail"></i><span>Inbox</span></a></li>
                              <li> <a href="{{ route('admin.settings.index') }}"> <i
