    ...
    <div class="container-fluid">
        <div class="row">
                ...
                <div class="card">
                    ...
                    <div class="card-body badge-spacing">
                        ...
                        <button class="btn btn-primary" type="button" data-bs-toggle="modal"
                            ...
                            {{ $settings['general']['site_name'] }}</button>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-toggle-wrapper social-profile text-start dark-sign-up">
                                        <h3 class="modal-header justify-content-center border-0">{{ $settings['general']['site_name'] }} SIGN-UP</h3>
                                        <div class="modal-body">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="form-control" id="exampleFormControlInput1"
                                                            type="email" placeholder="{{ $settings['general']['site_name'] }}theme@gmail.com">
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content dark-sign-up">
                                    <div class="modal-body social-profile text-start">
                                        <div class="modal-toggle-wrapper">
                                            <h3>{{ $settings['general']['site_name'] }} Login</h3>
                                            <p>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4>{{ $settings['general']['site_name'] }} custom modals </h4>
                        <p class="f-m-light mt-1">
                            Custom Modal make by {{ $settings['general']['site_name'] }}.</p>
                    </div>
                    <div class="card-body">
                        <div class="row g-3">
                                ...
                                <div class="card-wrapper border rounded-3 h-100">
                                    <div class="Riho-demo-img">
                                        ...
                                        <div class="title-wrapper pb-3 modal-heading">
                                            ...
                                            <p>Example of {{ $settings['general']['site_name'] }} dashboard profile card.</p>
                                        </div>
                                ...
                                <div class="card-wrapper border rounded-3 h-100">
                                    <div class="Riho-demo-img">
                                        ...
                                        <div class="title-wrapper pb-3 modal-heading">
                                            ...
                                            <p>Example of {{ $settings['general']['site_name'] }} login form.</p>
                                        </div>
                                        <div class="overflow-hidden"><img class="img-fluid"
                                ...
                                <div class="card-wrapper border rounded-3 h-100">
                                    <div class="Riho-demo-img">
                                        ...
                                        <div class="title-wrapper pb-3 modal-heading">
                                            ...
                                            <p>Example of {{ $settings['general']['site_name'] }} dashboard balance card.</p>
                                        </div>
