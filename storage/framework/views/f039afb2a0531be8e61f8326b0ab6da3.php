<?php $__env->startSection('css'); ?>
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/css/vendors/emoji/uikit.min.css')); ?>">
                            ...
                            <div class="tab-pane fade show active" id="chats" role="tabpanel"
                                ...
                                <ul class="chats-user">
                                    ...
                                    <li class="common-space">
                                        <div class="chat-time">
                                            <div class="active-profile"><img class="img-fluid rounded-circle"
                                                    src="<?php echo e(asset('assets/images/avtar/11.jpg')); ?>" alt="user">
                                                <div class="status bg-success"></div>
                                            </div>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script src="<?php echo e(asset('assets/js/emoji-js/uikit.min.js')); ?>"></script>
...
<?php echo $__env->make('layouts.simple.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/dimitar/Desktop/Clients/FreelanceProjects/Croatia-Admin/themeforest-XMp4qKjR-riho-laravel-admin-template/riho-laravel-1.0.1/resources/views/chats/chat_private.blade.php ENDPATH**/ ?>