    ...
    <div class="container-fluid">
        <div class="row size-column">
                                    ...
                                    <div class="w-100 d-flex justify-content-between align-items-center">
                                        <div class="product-details">
                                            <div><span class="badge rounded-pill badge-light text-dark">SKU78589</span>
                                                ...
                                                href="{{ route('admin.product') }}">Noise
                                                - Wireless
                                    ...
                                    <div class="w-100 d-flex justify-content-between align-items-center">
                                        <div class="product-details">
                                            <div><span class="badge rounded-pill badge-light text-dark">SKU78596</span>
                                                ...
                                                href="{{ route('admin.product') }}">Anime
                                                White Half
                                                Sleev
            ...
            <div class="col-xxl-3 col-sm-6 box-col-6">
                <div class="card height-equal">
                    <div class="card-header card-no-border total-revenue">
                        <h4>New User </h4><a href="{{ route('admin.product') }}">View All</a>
                    </div>
                    <div class="card-body pt-0">
                        <div class="new-user">
                            <ul>
                                                ...
                                                <div class="activity-data d-flex align-items-center gap-3">
                                                    <div class="common-space gap-2 ">
                                                        <div class="user-activity me-3"><img
                                                                ...
                                                                href="{{ route('admin.edit_profile') }}">Floyd Miles</a>
                                                        </div>
                                                ...
                                                <div class="activity-data d-flex align-items-center gap-3">
                                                    <div class="common-space gap-2 ">
                                                        <div class="user-activity me-3"><img
                                                                ...
                                                                alt="user"><a class="f-10 f-w-500 username"
                                                                href="{{ route('admin.edit_profile') }}">Ralph Edwards</a>
                                                        </div>
                                                ...
                                                <div class="activity-data d-flex align-items-center gap-3">
                                                    <div class="common-space gap-2 ">
                                                        <div class="user-activity me-3"><img
                                                                ...
                                                                alt="user"><a class="f-10 f-w-500 username"
                                                                href="{{ route('admin.edit_profile') }}">Esther Howard</a>
                                                        </div>
                                                ...
                                                <div class="activity-data d-flex align-items-center gap-3">
                                                    <div class="common-space gap-2 ">
                                                        <div class="user-activity me-3"><img
                                                                ...
                                                                alt="user"><a class="f-10 f-w-500 username"
                                                                href="{{ route('admin.edit_profile') }}">Jacob Jones</a>
                                                        </div>
                                                ...
                                                <div class="activity-data d-flex align-items-center gap-3">
                                                    <div class="common-space gap-2 ">
                                                        <div class="user-activity me-3"><img
                                                                ...
                                                                alt="user"><a class="f-10 f-w-500 username"
                                                                href="{{ route('admin.edit_profile') }}">Theresa Webb</a>
                                                        </div>
                                                ...
                                                <div class="activity-data d-flex align-items-center gap-3">
                                                    <div class="common-space gap-2 ">
                                                        <div class="user-activity me-3"><img
                                                                ...
                                                                alt="user"><a class="f-10 f-w-500 username"
                                                                href="{{ route('admin.edit_profile') }}">Annette Black</a>
                                                        </div>
                                                        <div class="activity-time"><span class="f-light f-w-500 f-10">12
                                                                min ago</span></div>
                                                    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-footer">
                        <div class="common-space">
                            <div><a class="f-w-600 f-14 " href="{{ route('admin.default_dashboard') }}">Most Visited Day</a><span
