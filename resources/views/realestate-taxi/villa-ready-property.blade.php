...
.full-image{width:100%;height:auto;display:block;border-radius:14px;border:1px solid var(--line)}
...
<img alt="Milna, Island of Brač" onclick="openViewer(this.src)" src="/villa-ready-assets/villareadycroatia1.jpg"/>
<img alt="Milna aerial view and sea view" onclick="openViewer(this.src)" src="/villa-ready-assets/villareadycroatia2.webp"/>
<img alt="Aerial site" onclick="openViewer(this.src)" src="/villa-ready-assets/villareadycroatia5.jpg"/>
<img alt="Villa renders" onclick="openViewer(this.src)" src="/villa-ready-assets/villareadycroatia7.jpg"/>
</div></section><section class="card pad" id="chain-location"><div class="title"><div><h2>THE 4-VILLA CHAIN LOCATION</h2><p class="sub">A permitted development opportunity near the sea and Milna amenities.</p></div></div><div class="original-copy"><p>Discover an exceptional opportunity to own land in one of Milna's most attractive locations, with building permit availability near the sea and still within Milna's amenities. Just above Marina Vlaška, this site offers both tranquillity and convenience. We all like nature, but you still want to be in nature and not too far from the beach, shops, restaurants, ferry, and the centre of the place.</p><p>This is an elite location that still exists in Milna and attracts all these values at the same time.</p><p>You can look around and see green zones that will stay green. You can see with your own eyes that there is no space for more building development, even if the government decides to give permits to anyone.</p></div><img alt="Proximity details" class="full-image" onclick="openViewer(this.src)" src="/villa-ready-assets/details.webp"/></section><section class="card pad" id="sea-view"><div class="title"><div><h2>SEA VIEW FROM THE LOCATION</h2><p class="sub">The view and access value of the site.</p></div></div><div class="grid2"><div class="original-copy"><p>Boasting a beautiful sea view from the villa location, with easy access from both the upper road and the charming Riva (promenade); the only available location ideal for a stylish, highest-value holiday home in Milna.</p></div><img alt="Sea view from location" class="wide-image" onclick="openViewer(this.src)" src="/villa-ready-assets/villareadycroatia2.webp"/></div></section><section class="card pad" id="map-view"><div class="title"><div><h2>MAP VIEW OF THE LOCATION</h2><p class="sub">Walking access to essential amenities and the sea.</p></div></div><div class="original-copy"><p>Simplified map view shows easy access to all essential amenities — restaurants, shops, and the ferry port are all in close proximity, with a beautiful beach only 10 minutes away on foot. The first sea access is just 5 minutes walking away.</p></div><img alt="Map view of the location" class="wide-image" onclick="openViewer(this.src)" src="/villa-ready-assets/villareadycroatia3.webp"/></section><section class="stat-grid" id="project-numbers">
