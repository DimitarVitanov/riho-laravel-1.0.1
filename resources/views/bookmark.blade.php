                            ...
                            <div class="col-xxl-3 col-md-4 col-ed-4">
                                ...
                                <div class="details-website"><img class="img-fluid" src="{{ asset('assets/images/lightgallry/03.jpg') }}" alt="">
                                    ...
                                    <div class="title-bookmark">
                                        ...
                                        <div class="content-general">
                                        <p class="desc_2">{{ $settings['general']['site_name'] }} is beautifully crafted, clean and modern designed admin theme</p><span class="collection_2">Fs</span>
                                        </div>
                                    </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xxl-3 col-md-4 col-ed-4">
                                ...
                                <div class="details-website"><img class="img-fluid" src="{{ asset('assets/images/lightgallry/07.jpg') }}" alt="">
                                    ...
                                    <div class="title-bookmark">
                                        ...
                                        <div class="content-general">
                                        <p class="desc_0">{{$settings['general']['site_name']}} is beautifully crafted, clean and modern designed admin theme with 6 different demos and light - dark versions.</p><span class="collection_0">General</span>
                                        </div>
                                    </div>
                                    </div>
                                </div>
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row g-2">
                                ...
                                <textarea class="form-control" id="editdesc" required="" autocomplete="off">{{$settings['general']['site_name']}} is beautifully crafted, clean and modern designed admin theme with 6 different demos and light - dark versions.</textarea>
                                </div>
