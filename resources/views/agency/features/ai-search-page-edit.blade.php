...
@section('breadcrumb-items')
    ...
    <li class="breadcrumb-item"><a href="{{ route('agency.ai-search.pages.preview', $page) }}">{{ __('messages.preview') }}</a></li>
    <li class="breadcrumb-item active">{{ __('messages.edit') }}</li>
@endsection

@section('content')
<div class="container-fluid ai-search-edit">
    <div class="row mb-4">
        <div class="col-12">
            <div class="card">
                <div class="card-header bg-white border-bottom d-flex justify-content-between align-items-center py-3">
                    ...
                    <div>
                        <a href="{{ route('agency.ai-search.pages.preview', $page) }}" class="btn btn-outline-secondary btn-sm">{{ __('messages.cancel') }}</a>
                    </div>
                </div>
                <div class="card-body">
                    <form action="{{ route('agency.ai-search.pages.update', $page) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row g-2">
                            ...
                            <div class="col-12 col-md-auto">
                                <a href="{{ route('agency.ai-search.pages.preview', $page) }}" class="btn btn-outline-secondary w-100">{{ __('messages.cancel') }}</a>
                            </div>
                        </div>
                    </form>
                </div>
