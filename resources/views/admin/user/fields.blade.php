...
<div class="form theme-form">
                ...
                <div class="d-flex flex-column-reverse">
                    <select class="form-select gender-placeholder" name="gender">
                        ...
                        <option value="male"
                            ...
                            @endif
                            @if (old('gender') == 'male') selected @endif>{{ __('Male') }}</option>
                        <option value="female"
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="mb-3">
                ...
                <div class="d-flex flex-column-reverse">
                    <select class="form-select role-placeholder" name="role_id">
            ...
            <div class="mb-3">
                ...
                <select class="form-select country-placeholder" id="country" name="country_id">
                    ...
                    @foreach ($countries as $key => $value)
                        <option value="{{ $key }}"
                            {{ old('country_id', $user->country_id) == $key ? 'selected' : '' }}>
                            {{ $value }}</option>
                    @endforeach
                </select>
            </div>
        ...
        <div class="col">
            <div class="mb-3">
                ...
                <textarea class="form-control" id="exampleFormControlTextarea4" rows="2" name="about_me"
                    placeholder="Enter About Me">{{ isset($user->about_me) ? $user->about_me : old('about_me') }}</textarea>
                @error('about_me')
                    <span class="text-danger d-block">
                        <strong>{{ $message }}</strong>
                    </span>
    ...
    <div class="row">
        <div class="col">
            <div class="mb-3">
                <label>Bio</label>
                <textarea class="form-control" id="" rows="4" name="bio" placeholder="Enter Bio">{{ isset($user->bio) ? $user->bio : old('bio') }}</textarea>
                @error('bio')
                    <span class="text-danger d-block">
                        <strong>{{ $message }}</strong>
                    </span>
