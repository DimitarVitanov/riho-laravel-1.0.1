                                        ...
                                        <div class="col-sm-6">
                                            <div class="media">
                                                <div class="media-left">
                                                    <img class="img-fluid for-light media-object img-60"
                                                        src="{{ asset($settings['general']['dark_logo']) }}" alt="logo-light">
                                                    <img class="img-fluid for-dark media-object img-60"
                                                        src="{{ asset($settings['general']['light_logo']) }}" alt="logo-dark">
                                                </div>
                                                <div class="media-body m-l-20 text-right">
                                                    <p>hello@ {{ $settings['general']['site_name'] }}.in<br><span>289-335-5590</span></p>
                                                </div>
                                            </div>
                                            <!-- End Info-->
                                        </div>
