    ...
    <div class="container-fluid">
        ...
        <div class="vb-card" style="margin-bottom: 28px;">
            ...
            <div style="display:flex;flex-wrap:wrap;gap:10px;">
                <span class="vb-badge <?php echo e($profile->can_manage_agencies ? 'vb-badge-success' : 'vb-badge-muted'); ?>">Manage Agencies</span>
                <span class="vb-badge <?php echo e($profile->can_manage_investors ? 'vb-badge-success' : 'vb-badge-muted'); ?>">Manage Investors</span>
                <span class="vb-badge <?php echo e($profile->can_review_ai_outputs ? 'vb-badge-success' : 'vb-badge-muted'); ?>">Review AI Outputs</span>
                <span class="vb-badge <?php echo e($profile->can_prepare_payouts ? 'vb-badge-success' : 'vb-badge-muted'); ?>">Prepare Payouts</span>
                <span class="vb-badge <?php echo e($profile->can_view_financials ? 'vb-badge-success' : 'vb-badge-muted'); ?>">View Financials</span>
                <span class="vb-badge <?php echo e($profile->can_login_as_user ? 'vb-badge-success' : 'vb-badge-muted'); ?>">Login As User</span>
            </div>
        </div>
        ...
        <div class="vb-grid-3">
            <div class="vb-card">
                ...
                <a href="<?php echo e(route('manager.content-review.index')); ?>" class="vb-btn vb-btn-sm">Open</a>
            </div>
            <div class="vb-card">
                ...
                <a href="<?php echo e(route('manager.capital-calls.index')); ?>" class="vb-btn vb-btn-sm">Open</a>
            </div>
            <div class="vb-card">
                ...
                <a href="<?php echo e(route('manager.payout-preparation.index')); ?>" class="vb-btn vb-btn-sm">Open</a>
            </div>
        </div>
    </div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.simple.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/dimitar/Desktop/Clients/FreelanceProjects/Croatia-Admin/themeforest-XMp4qKjR-riho-laravel-admin-template/riho-laravel-1.0.1/resources/views/manager/dashboard.blade.php ENDPATH**/ ?>