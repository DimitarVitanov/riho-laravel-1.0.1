<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <meta name="description" content="{{ $settings['general']['site_name'] }} admin is super flexible, powerful, clean &amp; modern responsive bootstrap 5 admin template with unlimited possibilities.">
    <meta name="keywords" content="admin template, {{ $settings['general']['site_name'] }} admin template, dashboard template, flat admin template, responsive admin template, web app">
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('frontend/css/vendors/icofont.css') }}">
    <link rel="icon" href="{{ asset('frontend/svg/landing-icons.svg') }}">
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('frontend/css/vendors/swiper/swiper-bundle.min.css') }}">
